...
import { ArrowRight, Clock3, Monitor, Smartphone, Laptop } from 'lucide-react'
	...
	return (
		<section className="border-t bg-[var(--bg-elevated)]" style={{ borderColor: 'var(--border)' }}>
			<div className="container-page py-16 md:py-24">
				...
				<div
					className="mt-14 grid border-l border-t md:grid-cols-3"
						...
						return (
							...
							>
								<div className="flex h-full flex-col justify-between gap-10">
									...
									<div>
										<h3 className="text-2xl font-semibold">{label}</h3>
										<p className="mt-3 text-sm leading-7 text-[var(--fg-muted)]">{description}</p>
