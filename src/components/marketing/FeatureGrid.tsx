...
import { KeyRound, Activity, SlidersHorizontal, EyeOff, Laptop, Monitor, type LucideIcon } from "lucide-react";
import Reveal from "./Reveal";

const ITEMS: { key: string; icon: LucideIcon }[] = [
  { key: "pairing", icon: KeyRound },
  { key: "stats", icon: Activity },
  { key: "adaptive", icon: SlidersHorizontal },
  { key: "keepAwake", icon: EyeOff },
  { key: "macHost", icon: Laptop },
  { key: "winHost", icon: Monitor },
];
